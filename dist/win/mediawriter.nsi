...
!else
    ...
    !if "${CERTPASS}" != ""
        !system 'osslsigncode sign -pkcs12 "${CERTPATH}/authenticode.pfx" -readpass "${CERTPASS}" -h sha256 -n "Obsidian Media Writer" -i https://github.com/reapercanuk39/Obsidian -t http://timestamp.comodoca.com/authenticode -in "../../build/wineprefix/drive_c/uninstall.unsigned.exe" -out "../../build/wineprefix/drive_c/uninstall.exe" ' = 0
    !else
